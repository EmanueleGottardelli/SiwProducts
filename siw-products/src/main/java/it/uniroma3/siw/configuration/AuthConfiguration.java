...
public class AuthConfiguration{
	...
	/**
	 * 
	 * la sorgente dati contenente le credenziali
	 * è iniettata automaticamente
	 * 
	 */
	...
	/**
	 * 
	 *  metodo che contiene le impostazioni di configurazione
	...
	protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
		...
		.requestMatchers(HttpMethod.GET, 	"/", "/index", "/login", "/register", "/css/**", "/images/**", "/operazioniMovies", "/operazioniArtists",
										"/product","/product/**", "/foundProducts", "/formSearchProducts").permitAll()
	...
	public void configure(AuthenticationManagerBuilder auth) throws Exception{
		...
		.authoritiesByUsernameQuery("SELECT username, password, 1 as enabled FROM credentials WHERE username=?");
	}
	
	/**
	 * 
	 * metodoper criptare e decriptare le password
	 * 
	 */
